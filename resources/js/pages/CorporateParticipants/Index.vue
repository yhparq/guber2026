    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                ...
                <Button as-child>
                    <Link href="/corporate-participants/create">Nuevo Corp. Participante</Link>
                </Button>
            </div>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 dark:bg-gray-800 text-xs uppercase font-medium border-b border-sidebar-border/70 dark:border-sidebar-border">
                            <tr>
                                ...
                                <th class="px-4 py-3">Nombres/Empresa</th>
                        ...
                        <tbody class="divide-y divide-sidebar-border/70 dark:divide-sidebar-border">
                            ...
                            <tr v-if="participants.length === 0">
                                <td colspan="16" class="px-4 py-8 text-center text-gray-500">
                                    No se encontraron participantes corporativos registrados.
                                </td>
                            </tr>
                        </tbody>
                    </table>
